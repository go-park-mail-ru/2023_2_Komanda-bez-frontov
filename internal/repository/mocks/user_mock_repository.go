...
func (r *userMockRepository) FindByUsername(_ context.Context, name string) (*repository.User, error) {
...
func (r *userMockRepository) Delete(_ context.Context, name string) error {
